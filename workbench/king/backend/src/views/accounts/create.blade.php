@section('title')
    {{ trans('backend::main.accounts_create_title') }}
@show
...
<li class="active">{{ trans('backend::main.accounts_create_addnewacc') }}</li>
@show

@section('pageinfo')
    <h4 class="admin-page-name">{{ trans('backend::main.accounts_create_pagetitle') }}</h4>
@show
