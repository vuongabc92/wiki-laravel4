...
<div class="_fwfl">
    ...
    {{ Form::open(array('url' => 'admin/category-one/delete-all', 'method' => 'DELETE', 'class' => '_fwfl _mt5')) }}
        <button type="submit" class="btn btn-danger"><i class="fa fa-trash"></i> Delete</button>
        <a href="{{ url('admin/category-one') }}" class="btn btn-default"><i class="fa fa-arrow-left"></i> back</a>
    {{ Form::close() }}
</div>
@show