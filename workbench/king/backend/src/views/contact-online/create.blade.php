@section('title')
    Add new contact online
@show

@section('breadcrumb')
<li><a href="{{ url('/admin') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
<li><a href="{{ url('/admin/contact-online') }}">contact online</a></li>
<li class="active">add new contact online</li>
@show

@section('pageinfo')
    <h4 class="admin-page-name">Add new contact</h4>
@show
...
<div class="_fwfl">
    ...
    {{ Form::open(array('url' => url('/admin/contact-online'), 'method' => 'POST', 'role' => 'form', 'class' => 'form-horizontal')) }}
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-9">
                <h3 class="_fwfl _tb _fs20 form-title"><i class="fa fa-anchor"></i> Add new contact online</h3>
            </div>
        </div>
        @if(count($errors) > 0)
        <div class="form-group">
        ...
        @endif
        <div class="form-group">
            <label class="col-sm-2 control-label">Contact online <sup class="text-danger">*</sup></label>
            <div class="col-sm-9">
                @if(count($contactType) > 0)
                    ...
                    @endforeach
                    {{ Form::select('contact_type_id', $listType, '',array('class' => 'form-control')) }}
                @else
