...
<html>
    <head>
        <title>{{ trans('backoffice::backoffice.title') }} | @yield('title')</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="alert alert-danger _fwfl  _tc _r0 _b0 _tw _bgr _fwb _fs13 _m0">
            ...
            <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">{{ trans('backoffice::common.close') }}</span></button>
        </div>
        @endif
        @if(Session::has('success'))
        <div class="alert alert-success _fwfl  _tc _r0 _b0 _tw _bgs _fwb _fs13 _m0">
            ...
            <div class="_fl left-col">
                ...
                <div class="_fwfl admin-box">
                    <h4 class="_fwfl _fs16 _tb _m0 hallo-admin">
                        <span class="_fs13 hallo">{{ trans('backoffice::backoffice.hello') }} </span>
                        Vuong bui
                        <sup><i class="fa fa-star _fs13"></i></sup>
                    </h4>
                    <a href="#" class="_fl _r3 _td_i _fs12 edit-acc-nav"><i class="fa fa-gear"></i> {{ trans('backoffice::backoffice.settings') }}</a>
                </div>
                ...
                <ul class="_fwfl _db _m0 vertical-nav">
                    <li class="vertical-nav-top">
                        <a href="{{ url('admin') }}">
                            ...
                            <span class="left-nav-txt">{{ trans('backoffice::backoffice.dashboard') }}</span>
